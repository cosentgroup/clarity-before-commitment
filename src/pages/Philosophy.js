...
export default function Philosophy() {
  ...
  return (
    <div className="page fade-in">
      ...
      <p className="lead">People don't need more opportunity. They need better decision-making before commitment.</p>
      <hr className="divider" />
      <p>Clarity Before Commitment exists to help people make sober, informed decisions about entering demanding businesses. Many opportunities look simple from the outside and punishing from the inside.</p>
      <p>We provide structured diagnostics and decision frameworks that surface hidden requirements, real costs, and personal fit — so people can choose to proceed, pause, or redirect with confidence.</p>
      ...
      <div className="band band-teal" style={{ marginTop:'3.25rem' }}>
        <blockquote>
          Good decisions do not eliminate risk.<br />They ensure the risk you take is understood.
        </blockquote>
      </div>

      <div style={{ textAlign:'center', marginTop:'1rem' }}>
        <button className="btn btn-primary" onClick={() => nav('/scan')}>Take the free scan</button>
      </div>
    </div>
  );
}
