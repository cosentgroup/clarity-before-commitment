    ...
    <div className="page fade-in">
      <div style={{ paddingTop: '1.5rem' }}>
        ...
        <p className="lead" style={{ maxWidth: '520px' }}>
          Most business opportunities don't fail because they don't work. They fail
          because people commit before they understand what they're committing to.
        </p>
        <p style={{ maxWidth: '480px', marginTop: '0.25rem' }}>
          We help serious people slow down, see clearly, and make decisions they won't regret.
        </p>
        <div className="btn-row">
          <button className="btn btn-primary" onClick={() => navigate('/amazon-fba')}>
      ...
      <div>
        ...
        <p>Clarity Before Commitment exists to answer that before money, time, or identity are on the line.</p>
      </div>
      ...
      <div>
        ...
        <div className="cards-3">
          {[
            ...
            { n: '03', title: 'Commitment Roadmap', meta: '$199 · Reference guide', body: 'A grounded execution framework — only when proceeding is genuinely appropriate.' }
          ].map(s => (
            <div key={s.n}>
        ...
        <p style={{ fontSize: '12px', marginTop: '1.75rem', letterSpacing: '0.02em', color: 'var(--ink-3)' }}>
      ...
      <div style={{ marginTop: '3.5rem', textAlign: 'center' }}>
        <p style={{ fontSize: '13px', color: 'var(--ink-3)', marginBottom: '1.25rem' }}>
