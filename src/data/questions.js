export const questions = [
  {
    id: 1,
    section: "Motivation",
    text: "What most attracted you to Amazon FBA?",
    opts: [
      "The income potential",
      "The flexibility and lifestyle it appears to offer",
      "I've seen others succeed and want to explore it",
      "I enjoy analytical, operational work",
      "I'm gathering information — not yet decided"
    ],
    w: [0, 2, 3, 4, 5]
  },
  {
    id: 2,
    section: "Timeline",
    text: "If meaningful results took 12–18 months to materialise, how would that feel?",
    opts: [
      "That is not what I expected",
      "Very discouraging",
      "Difficult, but manageable",
      "That timeline seems realistic",
      "Expected — I've done my research"
    ],
    w: [0, 0, 3, 4, 5]
  },
  {
    id: 3,
    section: "Capital",
    text: "How would you describe your financial cushion for this venture?",
    opts: [
      "None — I need this to work quickly",
      "Very limited; mistakes would be painful",
      "Some flexibility, but tight",
      "Moderate; I can absorb learning costs",
      "Comfortable; a loss would not threaten my stability"
    ],
    w: [0, 0, 2, 4, 5]
  },
  {
    id: 4,
    section: "Time",
    text: "How many hours per week could you consistently allocate?",
    opts: [
      "Fewer than 2 hours",
      "2–5 hours",
      "5–10 hours",
      "10–20 hours",
      "20 or more — this would be my primary focus"
    ],
    w: [0, 0, 2, 4, 5]
  },
  {
    id: 5,
    section: "Work style",
    text: "Which describes your working preferences most accurately?",
    opts: [
      "I strongly dislike detailed, repetitive analytical tasks",
      "I prefer creative or people-focused work",
      "I can tolerate analytical work when necessary",
      "I'm comfortable with data and optimisation",
      "I genuinely enjoy systematic problem-solving"
    ],
    w: [0, 1, 3, 4, 5]
  },
  {
    id: 6,
    section: "Resilience",
    text: "When progress is slower than expected, how do you typically respond?",
    opts: [
      "I usually abandon the effort",
      "I become discouraged quickly",
      "I grow anxious but push through",
      "I stay patient and adjust my approach",
      "I expect this — it rarely affects my commitment"
    ],
    w: [0, 0, 3, 4, 5]
  },
  {
    id: 7,
    section: "Platform risk",
    text: "How do you feel about building a business on a platform you do not control?",
    opts: [
      "Very uncomfortable — I need control",
      "I hadn't considered this",
      "Somewhat uneasy, but I understand the tradeoff",
      "Comfortable — that is part of the model",
      "I actively plan for platform dependency risks"
    ],
    w: [0, 1, 3, 4, 5]
  },
  {
    id: 8,
    section: "Commitment",
    text: "What would failure in this business mean to you personally?",
    opts: [
      "Something I'd struggle to recover from emotionally",
      "A serious financial setback",
      "A frustrating but acceptable outcome",
      "A learning experience with real costs",
      "Part of the process — not identity-defining"
    ],
    w: [0, 0, 2, 4, 5]
  },
  {
    id: 9,
    section: "Intention",
    text: "Which statement most accurately describes your position right now?",
    opts: [
      "I want this to work quickly",
      "I'm hopeful but uncertain what to expect",
      "I'm exploring fit, not just outcomes",
      "I want to understand the full reality before deciding",
      "I'm open to discovering a better-suited direction"
    ],
    w: [0, 2, 3, 4, 5]
  }
];
...
export function scoreAnswers(answers) {
  const raw = questions.reduce((sum, q) => {
    ...
    return sum + (chosen !== undefined ? q.w[chosen] : 0);
  }, 0);
...
export const archetypes = [
  ...
  { n: 'V',   title: 'Systems and operations',       body: 'Process-heavy, high delegation potential. Rewards structure and tolerance for operational complexity.' }
];
